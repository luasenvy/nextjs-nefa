...
export default function Footer() {
  return (
    <footer className="mx-auto max-w-screen-xl px-8">
      <div className="w-full border-[#DDDDDD] border-y">
        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4">
          ...
          <div className="w-full border-[#DDDDDD] border-t py-6 sm:w-1/2 sm:border-t sm:px-16 sm:py-12 md:w-full lg:w-full lg:border-r xl:w-fit xl:border-r">
            <ul className="space-y-4">
          ...
          <div className="w-full border-[#DDDDDD] border-t py-6 sm:w-1/2 sm:border-t-0 sm:border-r-0 sm:px-16 sm:py-12 md:w-full md:border-t lg:w-full xl:w-fit">
            <ul className="space-y-4">
          ...
          <div className="w-full space-y-4 border-[#DDDDDD] py-6 sm:w-1/2 sm:border-t sm:px-10 sm:py-12 md:w-full md:border-t lg:w-full xl:w-[22rem]">
            <h5 className="font-medium text-[#666666] text-sm focus:shadow-outline focus:outline-none">
              Newsletter
            </h5>
            <p className="text-[#666666] text-sm focus:shadow-outline focus:outline-none">
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <button className="rounded-md bg-blue-gradient px-4 py-4 text-white transition duration-300 hover:shadow-md sm:py-3">
                <ArrowForwardRounded />
              </button>
            </div>
          </div>
      ...
      <div className="py-8 text-center text-[#666666] text-sm hover:text-gray-900 sm:py-4">
